...
print("\nFiltering to specialty-relevant codes...")
...
proc_matrix_labeled = proc_matrix_filtered[labeled_indices]
...
proc_tensor_full = torch.FloatTensor(proc_matrix_filtered.toarray()).to(device)
...
if len(safe_latent_dims) == 0:
    print("\nWARNING: No safe latent dimensions found.")
...
metadata = {
    ...
    'specialty_code_indices': all_specialty_codes,
    'original_procedure_dim': proc_matrix.shape[1],
    'final_train_loss': final_train,
    'final_val_loss': final_val,
    'final_test_loss': test_loss,
    'val_train_ratio': phase1_val_ratio,
    'test_train_ratio': phase1_test_ratio,
...
for epoch in range(50):
    ...
    for i in range(n_batches):
        ...
        batch_x = proc_tensor_full[batch_idx]
...
torch.save(overlap_model.state_dict(), 'overlap_autoencoder.pth')
print("Saved: overlap_autoencoder.pth")
...
np.save('overlap_embeddings_32d.npy', overlap_embeddings)
print("Saved: overlap_embeddings_32d.npy")

# ============================================================================
# PHASE 3: SEMI-SUPERVISED COMPRESSION
# ============================================================================
...
torch.save(compression_model.state_dict(), 'phase3_compression_network.pth')
...
final_metadata = {
    'pipeline': 'unified_with_overlap_semisupervised',
