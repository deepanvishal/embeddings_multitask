...
BATCH_SIZE = 64
BATCH_SIZE_INFERENCE = 256  # Batch size for inference/encoding
...
# Filter to specialty-relevant codes only (union of all specialty codes)
...
# Filter procedure matrix to only relevant codes
